                            ...
                            try:
                                ...
                                if key not in [measure["_id"] for measure in new_measures] and not self.has_measure(
                                    ...
                                    wind_direction = self.get_corrected_value(
                                        mysql_cursor, wind_direction, station_no, self.wind_direction_type
                                    )

                                    try:
                                        temperature = self.get_last_measure_value(
                                            temperature_rows, measure_date + timedelta(seconds=10)
                                        )
                                    except NoMeasure:
                                        temperature = None
                                        pass
                                    ...
                                    try:
                                        humidity = self.get_last_measure_value(
                                            humidity_rows, measure_date + timedelta(seconds=10)
                                        )
                                    except NoMeasure:
                                        humidity = None
                                        pass
